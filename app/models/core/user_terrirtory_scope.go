...
// UserTerritoryScope [...]
type UserTerritoryScope struct {
...
func (m *UserTerritoryScope) TableName() string {
	return "core_user_territory_scope"
}

// UserTerritoryScopeColumns get sql column name.
var UserTerritoryScopeColumns = struct {
	ID              string
	UserID          string
	TerritoryID     string
