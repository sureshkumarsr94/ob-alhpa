...
func (s *stockService) GetJourneyPlan(journeyPlanID string) (payload journeyPlanDto.JourneyPlanResponse) {
...
func (s *stockService) SaveJourneyPlan(params journeyPlanDto.JourneyPlanRequest) (journeyPlanID string, handle dto.HandleError) {
